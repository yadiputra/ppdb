            ...
            <div class="row g-5">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <a href="#"><img class="position-absolute w-100 h-100 rounded wow zoomIn brosur" data-wow-delay="0.9s" src="<?php echo base_url(); ?>assets/img/bosur_.jpg" style="visibility: visible; animation-delay: 0.9s; animation-name: zoomIn;"></a><a>
                    </a></div><a>
                </a></div><a>
            </a></div><a>
        </a></div><a>
        ...
        <div class="container py-3 px-4">
            <div class="row g-5">
                ...
                <div class="col-lg-5" style="min-height: 500px;" data-aos="fade-up">
                    <div class="position-relative h-100">
                        <a href="#"><img class="position-absolute w-100 h-100 rounded wow zoomIn brosur" data-wow-delay="0.9s" src="<?php echo base_url(); ?>assets/img/ppdb.png" style="visibility: visible; animation-delay: 0.9s; animation-name: zoomIn;"></a><a>
                    </a></div><a>
                </a></div><a>
            </a></div><a>
        </a></div><a>
	...
	<div class="container" data-aos="fade-up">
	 <div class="row row-cols-1 row-cols-sm-2 row-cols-md-1 g-3">
        <div class="col mbt-2" data-aos="zoom-in" data-aos-delay="100">
          <div class="card shadow-sm">
           <div class="card-body text-center">
			<img class="img-flui w-100 h-100 rounded wow zoomIn brosur" data-wow-delay="0.9s" src="<?php echo base_url(); ?>assets/img/brosur1.PNG" style="visibility: visible; animation-delay: 0.9s; animation-name: zoomIn;">
            </div>
          </div>
        </div>
		<div class="col mbt-2" data-aos="zoom-in" data-aos-delay="100">
          <div class="card shadow-sm">
           <div class="card-body text-center">
			<img class="img-flui w-100 h-100 rounded wow zoomIn brosur" data-wow-delay="0.9s" src="<?php echo base_url(); ?>assets/img/brosur.PNG" style="visibility: visible; animation-delay: 0.9s; animation-name: zoomIn;">
            </div>
          </div>
        </div>
        </div>
